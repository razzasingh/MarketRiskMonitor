...
An automated market risk reporting system that produces a daily, self-contained HTML stress report for a multi-desk trading book (Rates, FX, Credit). The report is generated every weekday via GitHub Actions and published live via GitHub Pages — no manual steps required.
